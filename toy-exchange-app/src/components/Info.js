...
function Info() {
  return (
    <div className='flex flex-col md:flex-row items-center bg-sky-600 h-[550px] md:h-[350px]'>
        <div className='p-4'>
            <img src={kids} className='h-[300px] lg:h-[350px]  rounded-md'></img>
        </div>
        <div className='text-center text-[20px] md:ml-[40px] md:pr-4 lg:space-y-10 md:pt-10 md:h-[300px] space-y-4 '>
